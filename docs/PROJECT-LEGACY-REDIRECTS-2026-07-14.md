...
После слияния push-workflow выполнит генератор и сможет зафиксировать 14 redirect-страниц и удаление иных stale generated project pages автоматическим коммитом.
