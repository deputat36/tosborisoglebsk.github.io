...
Служебные термины контрактов: `baseline_required`, «измерительный режим» и «строгий режим». Первый используется до утверждения нового PNG, два других обозначают уровни проверки capture.
