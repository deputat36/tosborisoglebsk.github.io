...
async function renderSearch() {
  ...
  try {
    ...
    const items = [
      ...
      { type: 'Председателю', title: 'Председателю ТОС: рабочий кабинет, чек-листы и документы', text: 'председателю ТОС чек-листы практические инструкции первые 30 дней собрание конференция протокол устав документы проект смета новость фотоотчёт архив конфликт жалоба потребности жители актив Борисоглебск', url: '/chairperson/' },
