...
function patchMunicipalLegalStatus() {
  ...
  charter.description = 'Локальная копия Устава БГО с отметкой редакции 2024 года. Документ содержит положения об участии граждан, территориальном общественном самоуправлении, собраниях, конференциях, инициативных проектах и обращениях, но его текущая юридическая актуальность не подтверждена официальным источником.';
