...
<main id="main">
  ...
  <section class="hero"><div class="container hero-card"><div class="eyebrow">Диагностика workflow и Pages</div><h1>Проверка GitHub Actions</h1><p class="lead">Страница разделяет текущий снимок производных данных и исторический журнал проверок. Текущие метрики берутся из <code>data/site_health.json</code>, а CSV не выдаётся за состояние последнего запуска.</p><div class="hero-actions"><a class="btn primary" href="/data/actions_diagnostics.csv">Исторический CSV</a><a class="btn" href="/data/site_health.json">Текущий JSON</a><a class="btn" href="/site-health/">Общая сводка</a><a class="btn" href="/github-tasks/">Ручные задачи</a></div></div></section>

  <section class="section tight"><div class="container notice"><b>Роль страницы:</b> служебная диагностика автоматической генерации. Она не подтверждает GitHub Pages deployment и не заменяет проверку Actions UI.</div></section>
  ...
  <section class="section"><div class="container grid">
    ...
    <article class="card"><div class="card-inner"><h2>Что требует ручного контроля</h2><ul class="check-list"><li>открыть вкладку GitHub Actions;</li><li>проверить последний запуск <code>Generate TOS pages</code>;</li><li>при ошибке скачать job logs;</li><li>сверить GitHub Pages deployment;</li><li>фиксировать новый результат отдельной строкой CSV только после реальной проверки.</li></ul></div></article>
  </div></section>
