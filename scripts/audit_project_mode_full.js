...
const checks = [
  ...
  ['Generated page cleanup helper self-test', 'scripts/test_generated_page_cleanup.js'],
  ...
  ['Generated collection page cleanup audit', 'scripts/audit_generated_page_cleanup.js'],
  ...
  ['Visual comparison integration audit', 'scripts/audit_visual_comparison_integration.js'],
  ['User journey matrix audit', 'scripts/audit_user_journey_matrix.js'],
  ['Admin capability inventory audit', 'scripts/audit_admin_capabilities.js'],
