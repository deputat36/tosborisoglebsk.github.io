...
const checks = [
  ...
  ['Public audience focus', 'scripts/audit_public_audience_focus.js'],
  ...
  ['Publication queue contract and import self-test', 'scripts/test_publication_queue_import_validation.js'],
  ['Publication queue', 'scripts/audit_publication_queue.js'],
  ['Publication queue content', 'scripts/audit_publication_queue_content.js'],
  ['Publication queue import page', 'scripts/audit_publication_queue_import_page.js'],
  ...
  ['Priority TOS update evidence', 'scripts/audit_priority_tos_update_evidence.js'],
  ['Priority TOS update evidence self-test', 'scripts/test_priority_tos_update_evidence.js'],
  ['Priority TOS readiness', 'scripts/audit_priority_tos_readiness.js'],
