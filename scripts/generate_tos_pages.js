...
function updateSitemap(toses) {
  const baseUrls = ['/', '/tos/', '/news/', '/grants/', '/projects/', '/calendar/', '/needs/', '/materials/', '/documents/', '/legal/', '/create-tos/', '/chairperson/', '/update-tos/', '/map/', '/contacts/', '/editorial-policy/', '/search/'].map(u => `${SITE_URL}${u}`);
